...
# filter_str <- paste(filter_str, '$41\\"\\t\\"', sep='') #HAS MEDIA
  filter_str <- paste(filter_str, '$42\\"\\t\\"', sep='') #APPROVED	
  filter_str <- paste(filter_str, '$43\\"\\t\\"', sep='') #REVIEWED		
  filter_str <- paste(filter_str, '$44\\"\\t\\"', sep='') #REASON	
# filter_str <- paste(filter_str, '$45\\"\\t\\"', sep='') #TRIP COMMENTS	
# filter_str <- paste(filter_str, '$46\\"\\t\\"', sep='') #SPECIES COMMENTS	
################################################################
